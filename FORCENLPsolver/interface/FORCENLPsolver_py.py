...
a Python wrapper for a fast solver generated by FORCESPRO v5.1.0
   ...
   subject to the parameters supplied in the following dictionary:
       ...
       PARAMS['all_parameters'] - column vector of length 600
...
('x0', ctypes.c_double * 850),
('all_parameters', ctypes.c_double * 600),
...
('x41', ctypes.c_double * 17),
('x42', ctypes.c_double * 17),
('x43', ctypes.c_double * 17),
('x44', ctypes.c_double * 17),
('x45', ctypes.c_double * 17),
('x46', ctypes.c_double * 17),
('x47', ctypes.c_double * 17),
('x48', ctypes.c_double * 17),
('x49', ctypes.c_double * 17),
('x50', ctypes.c_double * 17),
]
