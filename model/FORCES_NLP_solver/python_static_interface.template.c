 ...
 *  - FORCES_NLP_solver_casadi2forces
...
void FORCES_NLP_solver_casadi2forces(SOLVER_FLOAT *x, SOLVER_FLOAT *y, SOLVER_FLOAT *l,
...
int FORCES_NLP_solver_interface(void *params, void *outputs, void *info, FILE *fp) {
    return SOLVER_FUN_NAME(params, outputs, info, fp, &FORCES_NLP_solver_casadi2forces);
}
