...
########################################################################################################
    ...
    def animate(i):
        line.set_xdata(real_trajectory[:i + 1, 0], real_trajectory2[:i + 1, 0])
        line.set_ydata(real_trajectory[:i + 1, 1], real_trajectory2[:i + 1, 1])
        line.set_3d_properties(real_trajectory[:i + 1, 2], real_trajectory2[:i + 1, 2])
